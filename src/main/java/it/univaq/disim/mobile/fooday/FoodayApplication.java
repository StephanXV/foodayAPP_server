...
public class FoodayApplication {
    ...
    @Bean
    public CommandLineRunner loadData(UtenteRepository utenteRepository, RistoranteRepository ristoranteRepository, NotiziaRepository notiziaRepository, TipologiaNotiziaRepository tipologiaNotiziaRepository, CorsoDiLaureaRepository corsoDiLaureaRepository, InsegnamentoRepository insegnamentoRepository, AppelloRepository appelloRepository) {
        return (args) -> {
